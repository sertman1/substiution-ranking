...
# IMPLEMENT YOUR RANKING METRIC HERE
def rankingmetric(target, candidates, context):
    orderedlist = {}

    for candidate in candidates:
        # For the sake of the template, assign each candidate the lowest possibly complexity score, 0 
        orderedlist[candidate] = 0
        # For example, you could add a complexity metric based off of word length with a desired weight:
        # orderlist[candidate] += lengthmetric(candidate)
